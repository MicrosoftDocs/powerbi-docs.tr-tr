...
2. Açık (veya Kapalı) kaydırıcısını seçerek Y eksenini açın veya kapatın. Şimdilik **Açık** durumunda bırakın.  Daha fazla veri için alan ayırmak üzere X eksenini kapatmak isteyebilirsiniz.
...
3. Ocak ayında brüt kâr %35'lerdeyken Nisan'da %45 ile zirveye ulaşıyor, Temmuz'da düşüyor ve Ağustos'ta tekrar zirveye çıkıyor. Geçen yıla ve bu yıla ait satış verilerini karşılaştırdığımızda benzer bir desen ile karşılaşacak mıyız?
4. **This Year Sales > Değer** ve **Last Year Sales** alanlarını çizgi grafiğe ekleyin. Geçen yıla ait brüt kâr yüzdesini gösteren **Gross Margin Last Year %** alanının (0M% kılavuz çizgisi boyunca görüntülenen mavi çizgi) ölçeği, satış verilerini gösteren **Sales** alanının ölçeğinden çok daha küçük olduğundan karşılaştırma işlemi zorlaşır. Y ekseni etiket yüzdeleri mantıksızdır.      
...
6. **Gross Margin Last Year %** alanını **Sütun Değerleri** demetinden alıp **Çizgi Değerleri** demetine sürükleyin. Artık yukarıda oluşturduğumuz yığılmış sütun grafiğimiz ***ve*** bir çizgi grafiğimiz vardır.  (İsteğe bağlı olarak, eksen yazı biçimi rengini ve boyutunu biçimlendirmek üzere yukarıda öğrendiklerinizi uygulayın.)
