...
description: Power BI kutucuklarındaki QR kodları ile, gerçek dünyadaki her şey Power BI Mobil uygulamasındaki ilgili BI bilgilerine arama gerekmeden doğrudan bağlanılabilir.
author: paulinbar
ms.author: painbar
ms.reviewer: ''
ms.service: powerbi
...
2. Kutucuğun sağ üst köşesindeki **Diğer seçenekler** (...) ve sonra **Odak modu**’nu ![Tam Ekran simgesi](media/service-create-qr-code-for-tile/fullscreen-icon.jpg) seçin.
3. Sağ üst köşedeki **Diğer seçenekler** (...) düğmesini ve **QR kodu oluştur**’u seçin. 
   
    ![Üç nokta menüsündeki işaretçinin QR kodu oluştur seçeneğini gösterdiği bir kutucuğun ekran görüntüsü.](media/service-create-qr-code-for-tile/power-bi-create-qr-code-tile.png)
4. QR kodunu içeren bir iletişim kutusu görünür. 
   
    ![QR kodunun indirilmeye veya kaydedilmeye hazır olduğunu gösteren bir iletişim kutusunun ekran görüntüsü.](media/service-create-qr-code-for-tile/pbi_qrcode_opportunity_count.png)
