...
Koşullu biçimlendirme kurallarını uygulamak için aşağıdaki resimde gösterildiği gibi koşullu biçimlendirmedeki **Uygula** açılan listesini kullanırsınız.
