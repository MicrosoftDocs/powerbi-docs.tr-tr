...
Power BI aşağıdaki resimde gösterildiği gibi Giriş tuvalinizi görüntüler. Giriş tuvalindeki düzen ve içerik her kullanıcıda farklıdır. Bu makalenin devamında, hem yeni bir kullanıcının hem de çok deneyimli bir kullanıcının Giriş tuvalini göreceğiz. 
 
![Power BI hizmetinin Giriş tuvali ekran görüntüsü.](media/end-user-home/power-bi-canvas.png)
...
- Giriş tuvali en sık ve en son kullandığınız içeriklerin yanı sıra, uygulama ve çalışma alanlarıyla birlikte önerilen içerikleri de görüntüleyip düzenler.  Power BI hizmetinde yeniyseniz Kullanmaya başlama bölümüne de sahip olursunuz. Açmak için bir kartı veya listedeki bir öğeyi seçin.
- Sol tarafta, gezinti bölmesi yer alır. Şunu seçin: ![Gezgin bölmesini genişletmek için hamburger simgesi](media/end-user-home/power-bi-expand.png) gezinti bölmesini genişletmek için. Bu gezinti bölmesinde içerik aynıdır ancak farklı şekilde düzenlenmiştir (Sık Kullanılanlar, Son Kullanılanlar, Uygulamalar ve Benimle Paylaşılanlar). Buradan, içerik listesini görüntüleyebilir ve açmak için birini seçebilirsiniz.
...
![Sık kullanılanlar açılır öğesi](./media/end-user-home/power-bi-home-favorites.png)
...
![öne çıkan içerik, yönetici tarafından öne çıkarılan](./media/end-user-home/power-bi-home-featured.png)

### <a name="recents-shared-with-me-and-my-apps"></a>Son Kullanılanlar, Benimle Paylaşılanlar ve Uygulamalarım
Sonraki bölüm, sekmeli bir listedir. 
- **Son Kullanılanlar** bölümünde, en son ziyaret ettiğiniz içerik görüntülenir. Her öğede zaman damgası olduğunu görebilirsiniz. 
- İş arkadaşlarınız, uygulamaların yanı sıra ayrı pano ve raporları da sizinle paylaşabilir. **Benimle Paylaşılanlar** bölümünde, iş arkadaşlarınızın sizinle paylaştığı pano ve raporları bulabilirsiniz. 
- **Uygulamalarım** bölümünde, sizinle paylaşılan veya [AppSource’tan indirdiğiniz](end-user-apps.md) uygulamalar listelenir. En son kullanılan uygulamalar burada listelenir. 

![Son Kullanılanlar sekmesinin seçili olduğu Giriş tuvali liste görünümü](./media/end-user-home/power-bi-recents.png)
...
![Giriş ekranının Çalışma alanları bölümünün ekran görüntüsü](./media/end-user-home/power-bi-workspaces-more.png)
...
Power BI, etkinliğinize ve hesap ayarlarınıza göre bir dizi önerilen uygulama görüntüler. Bir uygulama kartı seçildiğinde uygulama açılır. Mavi simgeli uygulamalar [şablon uygulamalarıdır](../connect-data/service-template-apps-overview.md).

![Giriş tuvalinde listelenen önerilen içerik](./media/end-user-home/power-bi-recommended.png)
 
### <a name="getting-started-learning-resources"></a>Öğrenme kaynaklarını kullanmaya başlama
Bunlar etkinliklerinize, ayarlarınıza ve Power BI yöneticisine bağlı olarak görüntülenen kaynaklardır. Yeni bir kullanıcıysanız Kullanmaya başlama bölümü Giriş tuvalinin üst kısmında görüntülenir. Yeni bir kullanıcıysanız ve artık Kullanmaya başlama bölümünü Giriş tuvalinin üst kısmında görmek istemiyorsanız **Aşağıya sabitle**’yi seçin.
...
![Power BI hizmeti gezinti bölmesinin ekran görüntüsü.](media/end-user-home/power-bi-nav-pane.png)
...
- Her kapsayıcıdaki son kullanılan öğeleri görmek için ( **>** ) açılır öğesini seçin.
    ...
    ![Son kullanılanlar için gezinti bölmesini kullanmayı gösteren video](media/end-user-home/recents2.gif)
...
İçerik, *kart* veya liste olarak görüntülenir. Kartlarda bir başlık ve simge vardır. Kart seçildiğinde içerik açılır.