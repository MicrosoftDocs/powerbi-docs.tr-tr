...
Bir uygulamayı açamıyorsanız yöneticinize veya yardım masasına ulaşın. Lisanslama hakkında bilgi edinmek için bkz. [Power BI lisanslaması](end-user-license.md).
...
4. İstediğiniz uygulamayı bulduğunuzda yüklemek için **Şimdi al**’ı seçin.

   ![Hemen al düğmesini gösteren ekran görüntüsü](./media/end-user-app-view/power-bi-get-now.png)
...
Doğrudan bağlantı aracılığıyla da kuruluş uygulaması yükleyebilirsiniz.    
...
Zaman ayırıp uygulamayı oluşturan pano ve raporlardaki verileri keşfedin. Filtreleme, vurgulama, sıralama ve detaya gitme gibi tüm standart Power BI etkileşimlerine erişiminiz bulunur.  Uygulamada gerçekleştirebileceğiniz eylemler, *tasarımcının* size atamış olduğu izinlere bağlıdır.  Uygulamadaki panolar ve raporlarla etkileşime geçme olanaklarınız, *tasarımcının* size atamış olduğu erişim düzeyine ve rollere bağlıdır. 

Panolar ve raporlar arasındaki fark hala kafanızı mı karıştırıyor?  [Panolar hakkındaki makaleyi](end-user-dashboards.md) ve [raporlar hakkındaki makaleyi](end-user-reports.md) okuyun.  
...
![Uygulamalar içerik listesinin ekran görüntüsü](./media/end-user-app-view/power-bi-apps-card.png)
...
![Uygulamanın üzerine geldiğinizde adını, zaman damgasını, sahibini ve eylemleri gösteren durumun ekran görüntüsü. ](./media/end-user-app-view/power-bi-app-hover.png)
...
![Farklı alanları numaralarla tanımlanmış Satış ve Pazarlama uygulamasını ekran görüntüsü ](./media/end-user-app-view/power-bi-app-number.png)
...
1. Uygulama gezinti bölmesi.  Uygulamanın adının altında içerik listesi yer alır. Bu uygulamada altı sayfalı bir rapor vardır. Açmak için bir rapor sayfası adı seçin. Şu anda *İade oranı* sayfası açık. 
1. **Filtreler** bölmesini genişletmek için oku seçin.

Erişim verildiyse ilişkili çalışma alanını da keşfedebilirsiniz.  Bir şablon uygulamasını yüklediğinizde veya indirdiğinizde Power BI hizmeti sizin için bir çalışma alanı oluşturur. Bir kuruluş uygulamasını yüklediğinizde ilgili çalışma alanına erişim verilmemiş olabilir. [Çalışma alanları hakkında bilgi edinin](end-user-workspaces.md). **Giriş**’e dönmek için **Power BI**’ı (2 numara) seçin ve **Çalışma Alanları** seçeneğini belirleyin. 
...
* Şablon uygulamasını AppSource'tan aldıysanız, uygulamayı bir sonraki açışınızda bir bildirim başlığı görürsünüz. Bildirimde size yeni sürümün kullanıma sunulduğu haberi iletilir. 
    ...
    2. Güncelleştirilmiş uygulamayı yüklemeniz istendiğinde **Yükle**'yi seçin. 
        ...
        ![Güncelleştirmeyi yükleme](./media/end-user-app-view/power-bi-installs.png) 
    ...
    3. Zaten bu uygulamanın bir sürümü sizde yüklü olduğunuzdan, mevcut sürümün değiştirilmesini mi yoksa güncelleştirilmiş uygulamanın yeni bir çalışma alanına yüklenmesini mi istediğinize karar verir.   
     ...
     > [!NOTE] 
     > Yeni bir sürüm yüklendiğinde, uygulamanın rapor ve panolarında yapmış olabileceğiniz değişikliklerin üzerine yazılır. Güncelleştirilmiş rapor ve panolarınızı tutmak için, yüklemeden önce bunları farklı bir adla veya farklı bir konuma kaydedebilirsiniz. 
...
- Uygulamaların kullanılması için bir Pro lisansı edinilmesi veya uygulamanın Premium paylaşılan kapasitedeki bir çalışma alanında depolanması gerekir. [Lisanslar hakkında bilgi edinin](end-user-license.md).
