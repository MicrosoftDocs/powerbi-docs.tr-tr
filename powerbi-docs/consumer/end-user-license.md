...
- İçerik (panolar, raporlar, uygulamalar) oluşturmak ve paylaşmak veya başkalarının sizinle paylaştığı içeriği açmak istiyorsanız Pro kullanıcı lisansına ihtiyacınız vardır. Power BI Pro'nun 60 günlük bağımsız deneme sürümüne kaydolabilirsiniz. Power BI hizmetinde Pro özelliklerden birini kullanmaya çalıştığınızda açılan yükseltme iletişim kutusunu seçin.
