...
![AppSource uygulamaları](./media/end-user-connect-to-services/overview.png)
...
![Power BI mobil uygulamasında Google Analytics uygulaması](./media/end-user-connect-to-services/power-bi-service-mobile-app-240.png)
...
1. Sol gezinti bölmesinde **Uygulamalar** seçeneğini belirleyin ve ardından uygulamayı seçin.
     ...
     ![Uygulamalar sayfası](./media/end-user-connect-to-services/power-bi-service-apps-open-app.png)
2. Soru-Cevap kutusuna yazarak soru sorabilir veya bağlantılı raporu açmak için bir kutucuğa tıklayabilirsiniz. 
   
    ![Google Analytics panosu](./media/end-user-connect-to-services/googleanalytics2.png)
...
* Sağ üst köşedeki soru işareti simgesini (**?**) seçin ve ardından **Yardım al** seçeneğini belirleyin.
    ...
    ![Yardım al simgesi](./media/end-user-connect-to-services/power-bi-service-get-help.png)
