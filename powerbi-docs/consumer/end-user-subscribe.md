...
![Abone ol simgesini seçme](./media/end-user-subscribe/power-bi-subscribes.png).
...
1. **Yeni abonelik ekle**'yi seçin.
   ...
   ![Abone ol penceresi](./media/end-user-subscribe/power-bi-email-numbered.png)
...
3. Her şey düzgün görünüyorsa, aboneliği kaydetmek için **Kaydet ve kapat**'ı seçin. Ayarladığınız zamanlamaya göre bir e-posta ve pano veya raporun anlık görüntüsünü alırsınız. Sıklığı **Veri yenilemesinden sonra** olarak ayarlanan tüm aboneliklerde, yalnızca söz konusu günde yapılan ilk zamanlanmış yenilemeden sonra e-posta gönderilir.
   ...
   ![panonun anlık görüntüsünü e-posta ile gönderme](media/end-user-subscribe/power-bi-subscriptions-email.png)
...
![Çalışma Alanım içinde tüm abonelikleri görüntüleme](./media/end-user-subscribe/power-bi-manage-subscription.png)
