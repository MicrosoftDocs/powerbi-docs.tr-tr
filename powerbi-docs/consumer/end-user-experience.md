...
1. app.powerbi.com adresini açın ve **Örnekler** bağlantısını seçin. 
    ...
    ![Power BI hizmetini ilk kez açın](./media/end-user-experience/power-bi-new-user.png)
...
![Panolar açılır](./media/end-user-experience/power-bi-open-dashboard.png)
...
1. Pano açıkken sağ üst köşeden **Sık kullanılanlara ekle** seçeneğini belirleyin.
   ...
   ![sık kullanılanlara ekleme](./media/end-user-experience/powerbi-dashboard-favorite.png)
...
4. Rapor adını seçerek raporu rapor düzenleyicisinde açın.
    ...
    ![raporu açma](./media/end-user-experience/power-bi-report-open.png)
...
Daha fazla bilgi edinmek için bkz. [Power BI'da gezinti: arama, sıralama, filtreleme](end-user-search-filter-sort.md)
