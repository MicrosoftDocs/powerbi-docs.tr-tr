...
* SAP BW Uygulama Sunucusu ([Kerberos ](service-gateway-sso-kerberos.md))
* SAP BW İleti Sunucusu ([Kerberos](service-gateway-sso-kerberos.md)) - Genel Önizleme
* Oracle([Kerberos](service-gateway-sso-kerberos.md)) - Genel Önizleme
* Teradata ([Kerberos](service-gateway-sso-kerberos.md))
* Spark ([Kerberos](service-gateway-sso-kerberos.md))
* Impala ([Kerberos](service-gateway-sso-kerberos.md))

Şu anda [M-uzantıları](https://github.com/microsoft/DataConnectors/blob/master/docs/m-extensions.md) için SSO'yu desteklemiyoruz.
...
1. Her sorgu için **Power BI hizmeti** yapılandırılmış ağ geçidine sorgu isteği gönderirken *kullanıcı asıl adını* (UPN, şu anda Power BI hizmetinde oturum açmış olan kullanıcının tam kullanıcı adı) ekler.
