...
Power BI'da *uygulamalar*, ilişkili panoları ve raporları tek bir yerde bir araya getirir. Kuruluşunuzdaki kişiler önemli iş bilgileri içeren uygulamalar oluşturabilir ve dağıtabilir. Google Analytics ve Microsoft Dynamics CRM gibi zaten kullanıyor olabileceğiniz [dış hizmetler](consumer/end-user-connect-to-services.md) de Power BI uygulamaları sunar. 

![Power BI'daki uygulamalar](./media/service-create-distribute-apps/power-bi-apps-left-nav.png)
...
Bir uygulama yazmayı mı planlıyorsunuz? Daha fazla bilgi için bkz. [Power BI'da çalışma arkadaşlarınızla çalışma alanları oluşturma](service-create-workspaces.md).
...
![Power BI hizmetinde uygulama giriş sayfası](./media/service-create-distribute-apps/power-bi-app-landing-page-opportunity-480.png)
...
![Mobil cihazda uygulama içerik listesi](./media/service-create-distribute-apps/power-bi-app-index-it-spend-360.png)
...
1. **Uygulamalar** ![Sol gezinti çubuğundaki Uygulamalar](./media/service-create-distribute-apps/power-bi-apps-bar.png) > **Uygulama edinin**'i seçin. 

     ![Uygulama edinin simgesi](./media/service-create-distribute-apps/power-bi-service-apps-get-apps-oppty.png)
2. AppSource'ta **Kuruluşum** altında, sonuçları daraltmak ve aradığınız uygulamayı bulmak için arama yapabilirsiniz.

     ![AppSource'ta Kuruluşum altında](./media/service-create-distribute-apps/power-bi-appsource-my-org.png)
...
Artık uygulamadaki panolar ve raporlarda bulunan verileri araştırabilirsiniz. Filtreleme, vurgulama, sıralama ve detaya gitme gibi tüm standart Power BI etkileşimlerine erişebilirsiniz. Ayrıca rapordaki tablodan veya başka bir görselden [verileri Excel'e aktarabilirsiniz](consumer/end-user-export-data.md). 

![Bir Power BI görselinden verileri dışarı aktarma](./media/service-create-distribute-apps/power-bi-service-export-data-visual.png)
