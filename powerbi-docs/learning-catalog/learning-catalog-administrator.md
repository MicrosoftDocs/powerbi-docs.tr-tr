---
title: Yöneticiler öğrenme kataloğu
...
ms.locfileid: "81268547"
---
# <a name="administrators-learning-catalog"></a>Yöneticiler öğrenme kataloğu
...
## <a name="deploy"></a>Dağıtma<a name="deploy"></a>
| İçerik | Açıklama  | Biçim | Uzunluk |
|-------------------------------------------------------------------------------------|---------------------------------------------------------------------|--------|--------|
...
| [Power BI Raporları için CICD İşlem Hattı (Azure DevOps)](https://community.powerbi.com/t5/Webinars-and-Video-Gallery/CICD-Pipeline-for-PowerBI-Reports-Azure-DevOps/td-p/864450)  | Bu videoda Power BI Desktop olmadan Power BI Raporlarını dağıtma işlemini nasıl otomatikleştirdiğimizi ve bu işlemi verimli bir şekilde yapmak için Azure DevOps /Powershell’den nasıl yararlanacağınızı öğreneceksiniz. | Web Semineri | 1 sa 12 dk 32 sn |
| [Power BI Hizmeti’nde Kişisel Yer İşaretleri](https://community.powerbi.com/t5/Webinars-and-Video-Gallery/Personal-Bookmarks-in-the-Power-BI-Service/td-p/616418)  | Power BI Hizmeti’nde kişisel yer işaretlerinin nasıl kullanılacağını gösteren ve genel olarak Power BI’da yer işaretlerini kullanmanın en iyi yöntemlerini açıklayan Charles Sterling ile Yana Berkovich’e katılın. Kişisel yer işaretini iyi bilmiyorsanız. bir rapor tüketicisi olarak artık bir rapor sayfasının çeşitli durumlarını yakalayıp (filtreler, dilimleyiciler ve görsellerin durumu gibi) her rapor için kendi yer işaretleri kümenizi oluşturabilecek ve daha sonra tek tıklamayla bu durumları her birine geri dönebileceksiniz! Hepsi bu değil. Ayrıca oluşturduğunuz her yer işaretini varsayılan görünüm yapabilecek, bu sayede raporu her açtığınızda tercih ettiğiniz görünüme girebileceksiniz. | Web Semineri | 43 dk 4 sn      |
