...
* [Azure Learning Studio örnek modeli](https://raw.githubusercontent.com/santoshc1/PowerBI‑AI‑samples/master/Tutorial\_MLStudio\_model\_integration/Automobile%20price%20data%20\_Raw\_.csv)
...
Henüz çalışma alanınız yoksa, soldaki menüde **Çalışma Alanları**'nı ve sonra da alttaki panelde **Uygulama çalışma alanı oluştur**'u seçerek bir çalışma alanı oluşturabilirsiniz.  Çalışma alanı ayrıntılarını girebileceğiniz bir panel açılır. Çalışma alanı adı girin ve **Kaydet**'i seçin.
