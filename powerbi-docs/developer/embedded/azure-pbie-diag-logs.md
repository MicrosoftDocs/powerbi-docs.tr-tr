---
title: Power BI tümleşik analizleri tümleşik çözümünüz için Azure'daki Power BI Embedded hizmetinin tanılama günlükleri
description: Power BI tümleşik analizleri tümleşik çözümünüz için Azure'daki Power BI Embedded hizmetinin tanılama günlüklerini oluşturma hakkında bilgi edinin.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
