...
dataType     |  Dize       |  Desteklenen [EDM veri türleri](https://msdn.microsoft.com/library/ee382832.aspx) ve kısıtlamalar. Bkz. [Veri türü kısıtlamaları](#data-type-restrictions).      |  Yanlış       | Doğru        
