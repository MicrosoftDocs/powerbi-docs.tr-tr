...
ms.locfileid: "76818997"
---
# <a name="dataviewutils"></a>DataViewUtils

`DataViewUtils`, Power BI özel görselleri için DataView nesnesini ayrıştırma işlemini basitleştirmeye yönelik bir dizi işlev ve sınıftır
