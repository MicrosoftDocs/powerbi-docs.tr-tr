...
* Power BI hizmetinde kullanıcıların rollere atanması, ekleme belirteci kullanıldığında RLS özelliğini etkilemez.
...
* Azure Analysis Services canlı bağlantıları desteklenmez.
