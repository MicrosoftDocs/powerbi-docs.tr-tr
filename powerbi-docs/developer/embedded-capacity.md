...
Hangi SKU’yu satın alacağınıza karar vermeden önce bu bölümdeki bilgileri gözden geçirin.
...
* [Kapasitenizi planlayıp test etmek](../service-premium-capacity-optimize.md#testing-approaches) için bu bağlantıyı kullanın

### <a name="power-bi-embedded-skus"></a>Power BI Embedded SKU’ları

Power BI Embedded, bir *A* SKU’su ile sunulur.
* [Power BI Embedded kapasitenizin neleri yapabileceğini öğrenin](https://powerbi.microsoft.com/blog/power-bi-developer-community-june-july-update/#Capacity-Plan)
* [ *A* SKU’su satın alın](../service-admin-premium-purchase.md#purchase-a-skus-for-testing-and-other-scenarios)
