---
title: "US Government müşterileriniz için Power BI içeriğini bir uygulamaya ekleme"
...
---
# <a name="embed-a-power-bi-dashboard-tile-or-report-into-your-application-for-us-government"></a>Bir Power BI panosunu, kutucuğunu veya raporunu US Government için uygulamanıza ekleme
...
Genel bulutun aksine, US Government bulutunun üç farklı kategori bölümü vardır.
...
Bu kılavuza başlamak için **Power BI US Government hesabınızın** olması gerekir. Ayarlanmış bir hesabınız yoksa [bir Power BI kamu hesabına kaydolabilirsiniz](../service-govus-signup.md).
...
REST API çağrıları gerçekleştirmek için uygulamanızı Azure AD'ye kaydetmeniz gerekir. Daha fazla bilgi için bkz. [Bir Azure AD uygulamasını Power BI içeriği eklemek üzere kaydetme](register-app.md). Bulunduğunuz kamu türüne bağlı olarak üç farklı kategori bölümü mevcut olduğundan, uygulamanızın kaydedilebileceği üç ayrı URL vardır.
...
Uygulamanızın içinden Power BI REST API'si çağrısı yapabilmek için önce Azure AD'den bir **erişim belirteci** almanız gerekir. Daha fazla bilgi için bkz. [Power BI uygulamanız için kullanıcıların kimliğini doğrulama ve Azure AD erişim belirteci alma](get-azuread-access-token.md). Bulunduğunuz kamu türüne bağlı olarak üç farklı kategori bölümü mevcut olduğundan, uygulamanıza yönelik bir erişim belirtecinin alınabileceği iki ayrı URL vardır.

* Kamu Topluluk Bulutu (GCC) - login.microsoftonline.com

* Askeri Yükleniciler (DoDCON) - login.microsoftonline.us

* Askeri (DoD) - login.microsoftonline.us
