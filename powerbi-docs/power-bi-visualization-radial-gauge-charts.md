---
title: "Power BI'daki radyal ölçek grafikleri (Eğitim)"
description: "Eğitim: Power BI'daki radyal ölçek grafikleri"
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
---
# <a name="radial-gauge-charts-in-power-bi-tutorial"></a>Power BI'daki radyal ölçek grafikleri (Eğitim)
Radyal ölçekler dairesel bir yay içerir ve belirli bir hedefe/KPI'ye yönelik ilerlemeyi ölçen tek bir değer görüntüler.  Hedef veya hedef değer çizgi (iğne) ile gösterilir. Hedefe yönelik ilerleme gölgelendirme ile gösterilir.  İlerlemeyi gösteren değer ise yayın içinde kalın olarak gösterilir. Olası tüm değerler, minimumdan (en soldaki değer) başlayıp maksimumda (en sağdaki değer) sonlanacak şekilde yay boyunca eşit olarak dağılır.
...
## <a name="when-to-use-a-radial-gauge"></a>Radyal ölçek ne zaman kullanılır?
Radial ölçekler şunlar için harika bir seçimdir:
...
## <a name="create-a-basic-radial-gauge"></a>Basit bir radyal ölçek oluşturma
...
### <a name="step-2-create-a-gauge-to-track-gross-sales"></a>2. Adım: Brüt Satışı izlemeye yönelik bir ölçek oluşturma
...
3. Sütun Grafiğini ölçek olarak değiştirmek için ölçek simgesini ![](media/power-bi-visualization-radial-gauge-charts/gaugeicon_new.png) seçin.
   
   Varsayılan olarak, Power BI, geçerli değerin (bu örnekte, Ortalama Gross Sales) ölçeğin ortasındaki değer olduğunun varsayıldığı bir Ölçek grafiği oluşturur. Ortalama Brüt Satış 182.760 ABD doları olduğundan, başlangıç değeri (Minimum) is 0 olarak, bitiş değeri ise (Maksimum) geçerli değerin iki katı olarak ayarlanır.
...
2. Toplama işlemini **Maksimum** olarak değiştirin.
   ...
   Ölçek, yeni bir bitiş değeriyle (Brüt satıştaki 1,21 milyon değeri) yeniden çizilir.
   
   ![](media/power-bi-visualization-radial-gauge-charts/power-bi-final-gauge.png)

### <a name="step-5-save-your-report"></a>5. Adım: Raporunuzu kaydetme
1. [Raporu kaydedin](service-report-save.md).
2. [Ölçek grafiğini pano kutucuğu olarak ekleyin](service-dashboard-tiles.md). 
...
3. **Ölçek ekseni**'ni genişletin ve **Minimum** ve **Maksimum** değerleri girin.
   
    ![](media/power-bi-visualization-radial-gauge-charts/power-bi-gauge-axis.png)
4. **COGS**'nin yanındaki onay işaretini kaldırarak geçerli hedef değeri silin.
   
    ![](media/power-bi-visualization-radial-gauge-charts/pbi_remove_target.png)
5. **Ölçek ekseni**'nin altında **Hedef** alanı göründüğünde, buraya bir değer girin.
   
    ![](media/power-bi-visualization-radial-gauge-charts/power-bi-gauge-target.png)
6. İsteğe bağlı olarak, ölçek grafiğinizi biçimlendirmeye devam edebilirsiniz.
