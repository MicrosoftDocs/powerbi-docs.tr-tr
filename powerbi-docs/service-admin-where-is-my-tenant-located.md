...
1. **Verilerinizin depolandığı yer** ifadesinin yanındaki değere bakın. Bu bölge, kiracınızın bulunduğu bölgedir. Ayrıca, çalışma alanlarınız için farklı bölgelerdeki ayrılmış kapasiteleri kullanmadığınız sürece verileriniz de bu bölgede depolanır.
