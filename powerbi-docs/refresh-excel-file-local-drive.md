...
Bir veri kaynağına bağlanmak için Power Query (Excel 2016'da Veri Al ve Dönüştür) kullandığınızda, verilerin yükleneceği yer konusunda birkaç seçeneğiniz vardır. Veri modeline veri yüklediğinizden emin olmak için, **Hedefe Yükle** iletişim kutusundan **Bu verileri Veri Modeline ekle** seçeneğini belirlemelisiniz.

> [!NOTE]
> Buradaki görüntü Excel 2016'yı göstermektedir.
> 
> 
...
Buna alternatif olarak, Gezgin'de **Düzenle**'ye tıklayarak Sorgu Düzenleyicisi'ni açabilirsiniz. Burada **Kapat ve Hedefe Yükle...** seçeneğine tıklayabilirsiniz.  
...
Hiç sorun değil. Şirket içi veya çevrimiçi veri kaynaklarına bağlanmak veya bu kaynaklarda veri sorgulamak için Power Pivot'u her kullandığınızda, veriler otomatik olarak veri modeline yüklenir.
...
Yenileme işlemini zamanlama hakkında daha fazla bilgi için bkz. [Yenilemeyi Zamanlama Yapılandırması](refresh-scheduled-refresh.md).
...
Bazen verileri yenileme beklendiği gibi gitmeyebilir. Bu, genellikle ağ geçidiyle bağlantılı bir sorun olur. Araçlar ve bilinen sorunlara yönelik sorun giderme makalelerine göz atın.

[Şirket içi veri ağ geçidiyle ilgili sorunları giderme](service-gateway-onprem-tshoot.md)

[Troubleshooting the Power BI Gateway - Personal (Power BI Gateway - Personal ile ilgili sorunları giderme)](service-admin-troubleshooting-power-bi-personal-gateway.md)
