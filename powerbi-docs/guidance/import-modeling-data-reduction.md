...
- Daha küçük model boyutları kapasite kaynakları, özellikle de bellek için çekişmeyi azaltır. Bu sayede daha fazla model daha uzun süreler için eşzamanlı olarak yüklenebildiğinden sonuçta daha düşük çıkarma ücretleri elde edilir. Daha fazla bilgi için [Power BI Premium Dağıtımı](../whitepaper-powerbi-premium-deployment.md) teknik incelemesinin [Kapasitelerin İşleyişi](../whitepaper-powerbi-premium-deployment.md#how-capacities-function) başlıklı bölümünü okuyun.
...
Bu amaçlara hizmet etmeyen sütunlar büyük olasılıkla kaldırılacaktır. Raporların kaldırılması _dikey filtreleme_ olarak adlandırılır.

Modelleri, bilinen raporlama gereksinimleri temelinde tam olarak doğru sayıda sütunla tasarlamanızı öneririz. Bu gereksinimler kuşkusuz zaman içinde değişebilir ama daha sonra sütun eklemenin kaldırmaktan daha kolay olduğunu aklınızda bulundurun. Sütunların kaldırılması raporları veya veri modelini bozabilir.
