...
> 
> [!IMPORTANT]
> Power BI yöneticileri, Yönetici portalından Web'de yayımla özelliğini kullanıcılar için devre dışı bırakabilir. **Kiracı ayarları** bölümündeki **Web'de yayımla** özelliğini **Kapalı** duruma getirin. Bu ayar, kiracıdaki tüm kullanıcılar için geçerlidir. Daha fazla bilgi için bkz. [Power BI yönetici portalı](service-admin-portal.md).
> 
> 
