...
![OData Akışı seçimini gösteren, Power BI Desktop’taki Veri Al şeridinin ekran görüntüsü.](media/desktop-connect-odata/connect-to-odata_1.png)

Açılan **OData Akışı** penceresine OData akışınızın URL'sini yazın veya yapıştırın ve **Tamam**'ı seçin.

![URL alanını gösteren OData Akışı iletişim kutusunun ekran görüntüsü.](media/desktop-connect-odata/connect-to-odata_2.png)
...
![Seçili tablolardaki verilerin önizlemesini gösteren Gezgin iletişim kutusunun ekran görüntüsü.](media/desktop-connect-odata/connect-to-odata_3.png)
...
![İçeri aktarma işleminin ilerleme durumunu gösteren Yükle iletişim kutusunun ekran görüntüsü.](media/desktop-connect-odata/connect-to-odata_4.png)
...
![Seçili tabloların listesini gösteren Alanlar bölmesinin ekran görüntüsü.](media/desktop-connect-odata/connect-to-odata_5.png)
