...
**Power BI hizmetinde** desteklenen R paketleri, **Desteklenen Paketler** adlı bir sonraki bölümde yer almaktadır. Söz konusu listede bulunmayan bir R paketi için destek isteğinde bulunmak isterseniz isteğinizi lütfen [Power BI Fikirleri](https://ideas.powerbi.com) üzerinden gönderin.
...
|düzeltme işareti|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|istenmeyen posta|2.1-3|https://cran.r-project.org/web/packages/spam/index.html|
