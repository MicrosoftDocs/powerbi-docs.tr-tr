...
- Erişim anahtarı
- Kayıt numarası
- Yalnızca Azure Yönetici rolleri kimlik doğrulaması yapabilir ve hesaplayıcıyı şirket verilerine bağlayabilir. (**Yalnızca Aralık 2020 önizleme sürümü için**)
