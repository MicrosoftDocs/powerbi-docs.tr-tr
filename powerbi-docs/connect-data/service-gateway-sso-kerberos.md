...
5. **Özellikler** iletişim kutusunda **Temsilci Seçme** sekmesi yoksa, bu hesapta elle SPN oluşturarak etkinleştirebilirsiniz. Windows ile birlikte gelen [setspn aracını](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/cc731241(v=ws.11)) kullanın. (SPN'yi oluşturmak için etki alanı yöneticisi haklarına sahip olmanız gerekir.)
