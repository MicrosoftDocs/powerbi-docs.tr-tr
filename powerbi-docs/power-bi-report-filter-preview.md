...
![Görsel için filtreler listesi](media/power-bi-report-filter-preview/power-bi-filter-visual.png)
...
Okuma modunda, bir görselin filtre simgesi üzerine gelin ve görseli etkileyen tüm filtreleri, dilimleyicileri, vb. içeren açılan listeyi görüntüleyin. Açılan listenin biçimlendirmesi Filtreler bölmesinin biçimlendirmesiyle aynıdır. 
...
![Filtre sıralama düzenini yeniden ayarlama](media/power-bi-report-filter-preview/power-bi-filter-sort.gif)
...
## <a name="filters-pane-scaling"></a>Filtreler bölmesini ölçeklendirme

Yeni Filtreler bölmesi rapor sayfası ve görsellerle birlikte ölçeklendirilir; bu sayede rapor sayfası ve Filtreler bölmesi birbiriyle orantılı kalır.
...
![Filtreler bölmesi erişilebilirliği](media/power-bi-report-filter-preview/power-bi-filter-accessible.png)
...
![Filtreyi yeniden adlandırma](media/power-bi-report-filter-preview/power-bi-filter-rename.png)
...
![Filtre türünü değiştirmeyi kısıtlama](media/power-bi-report-filter-preview/power-bi-filter-restrict-change.png)
