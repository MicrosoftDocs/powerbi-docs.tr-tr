...
* Benzer şekilde, SAP BW'ya bağlanırken bir **Sorgu Düzenleyicisi** yoktur. Veri kaynağı ayarları (örneğin, sunucu adı) **Sorguları Düzenle > Veri kaynağı ayarları** seçilerek değiştirilebilir. Herhangi bir Değişken ayarı, **Sorguları Düzenle > Değişkenleri Düzenle** seçilerek değiştirilebilir.
